...
The schema language is similar to [JSON Schema](https://json-schema.org/) and [OpenAPI](https://www.openapis.org/).
...
* [@atproto/lexicon](https://github.com/bluesky-social/atproto/tree/main/packages/lexicon) (TypeScript) - schema validation library
* [atproto-lexicon](https://github.com/socialweb-php/atproto-lexicon) (PHP) - A PHP-based Lexicon parser